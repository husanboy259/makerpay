...
const PLANS = [
  ...
  {
    key: 'basic', label: 'BASIC', emoji: '🔵', price: '8 000', period: 'so\'m/oy',
    color: 'text-blue-400', border: 'border-blue-500/20', bg: '',
    requests: '1 000', stores: '2', highlight: false,
    tag: null,
    features: ["API + Dashboard", "1 000 so'rov/oy", "2 ta do'kon", "2 ta provayder", "Webhook", "2 GB storage"],
  ...
  {
    key: 'standard', label: 'STANDARD', emoji: '🟣', price: '25 000', period: 'so\'m/oy',
    color: 'text-purple-400', border: 'border-purple-500/30', bg: 'bg-purple-500/5',
    requests: '5 000', stores: '5', highlight: true,
    tag: 'Eng ommabop',
    features: ["5 000 so'rov/oy", "5 ta do'kon", "Barcha provayderlar", "Analitika", "Webhook + Logs", "Email support", "10 GB storage"],
    disabled: ["Priority support"],
    cta: 'Boshlash', ctaLink: '/register', ctaStyle: 'bg-purple-600 hover:bg-purple-500 text-white',
  },
  {
    key: 'business', label: 'BUSINESS', emoji: '🔴', price: '65 000', period: 'so\'m/oy',
    color: 'text-red-400', border: 'border-red-500/20', bg: '',
    requests: '15 000', stores: '15', highlight: false,
    tag: null,
    features: ["15 000 so'rov/oy", "15 ta do'kon", "Barcha provayderlar", "Yuqori tezlik", "Priority support", "Batafsil analitika", "50 GB storage"],
    disabled: [],
